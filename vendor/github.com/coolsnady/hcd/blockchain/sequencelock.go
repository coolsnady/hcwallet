...
func (b *BlockChain) calcSequenceLock(node *blockNode, tx *hcutil.Tx, view *UtxoViewpoint, isActive bool) (*SequenceLock, error) {
...
func (b *BlockChain) CalcSequenceLock(tx *hcutil.Tx, view *UtxoViewpoint) (*SequenceLock, error) {
	b.chainLock.Lock()
