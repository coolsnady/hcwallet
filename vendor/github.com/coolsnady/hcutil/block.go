...
// Tx returns a wrapped transaction (hcutil.Tx) for the transaction at the
...
// STx returns a wrapped transaction (hcutil.Tx) for the stake transaction at
...
// Transactions returns a slice of wrapped transactions (hcutil.Tx) for all
...
// instead provides easy access to wrapped versions (hcutil.Tx) of them.
...
// STransactions returns a slice of wrapped stake transactions (hcutil.Tx) for all
