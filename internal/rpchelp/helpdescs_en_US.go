...
var helpDescsEnUS = map[string]string{
	...
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in HXD/KB",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in coolsnady",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in coolsnady",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in coolsnady",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and coolsnady amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in coolsnady",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in coolsnady",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in coolsnady",
	...
	"listtransactionsresult-amount":            "The value of the transaction output valued in coolsnady",
	...
	"listunspentresult-amount":        "The amount of the output valued in coolsnady",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in coolsnady",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in coolsnady to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in coolsnady",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in coolsnady",
	...
	"sendtomultisig-amount":      "Amount to send to the payment address valued in coolsnady",
	...
	"setticketmaxprice-max":       "The max price (in hxd).",
	...
	"settxfee-amount":    "The new fee per kB of the serialized tx size valued in coolsnady",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in coolsnady.",
	...
	"getwalletfee--result0":  "Current tx fee (in HXD)",
	...
	"purchaseticket-ticketfee":          "The transaction fee rate (HXD/kB) to use (overrides fees set by the wallet config or settxfee RPC)",
	...
	"setticketfee-fee":       "The new fee per kB of the serialized tx size valued in coolsnady",
