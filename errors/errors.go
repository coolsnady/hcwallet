// Copyright (c) 2018 The coolsnady developers
...
const (
	...
	NoPeers                         // coolsnady network is unreachable due to lack of peers or hxd RPC connections
)
...
func (k Kind) String() string {
	...
	case NoPeers:
		return "coolsnady network is unreachable"
	default:
