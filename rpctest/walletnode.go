...
// walletTestConfig contains all the args, and data required to launch a hcwallet process
...
// command returns the exec.Cmd which will be used to start the hcwallet
// process.
...
// to connect to the hcwallet process that is launched via Start().
...
// process, and as the base for the log and data directories for hcwallet.
...
// Start creates a new hcwallet process, and writes its pid in a file reserved
...
// Stop interrupts the running hcwalletTest process process, and waits until it exits
